...
if __name__ == '__main__':
    ...
    polluter_or_state_setter = detector.find_polluter_or_state_setter(test_list, test, task_type, task_scope)
    ...
    for pos in polluter_or_state_setter:
        cleaner = detector.find_cleaner(test_list, pos, test, "session")
